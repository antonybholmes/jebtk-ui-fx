...
public class FxUtils {
  ...
  public static StringBinding cssColorBinding(final String css, final ObjectProperty<Color> color) {
  ...
  public static StringBinding cssFillColorBinding(final ObjectProperty<Color> color) {
    return cssColorBinding("-fx-background-color", color);
  }
  
  public static StringBinding cssBorderColorBinding(final ObjectProperty<Color> color) {
  ...
  public static Color convert(java.awt.Color color) {
    return new Color(color.getRed() / 255.0,
